...
static volatile unsigned int *SW_MUX_GPIO5_IO04;
...
static int led_probe(struct platform_device *dev)
{
    ...
    SW_MUX_GPIO5_IO04 = ioremap(ledsource[1]->start, ressize[1]);
    gpio5_registers = ioremap(ledsource[2]->start, sizeof(struct imx6ull_gpio_registers));

    // 开启时钟
    *CCM_CCGR1 |= 0x11;

    // 配置io口为GPIO口
    *SW_MUX_GPIO5_IO04 &= ~(0xf);
    *SW_MUX_GPIO5_IO04 |= 0x5;
